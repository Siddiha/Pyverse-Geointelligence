  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m your GeoIntel AI assistant. I can help you analyze global news, provide insights about different countries, and answer questions about current events. What would you like to know?',
      timestamp: new Date()
    }
  ])
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-4xl h-[80vh] glass-effect rounded-xl flex flex-col"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-white/10">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Global Intelligence & News Analysis</p>
            </div>
          </div>
          <button
            onClick={onClose}
